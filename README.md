...
A standalone web app for matching client and seller availability for
property viewings. Runs entirely in the browser — no backend, no account.
...
5. You'll get a URL like viewing-matcher-xyz.vercel.app — that's the
